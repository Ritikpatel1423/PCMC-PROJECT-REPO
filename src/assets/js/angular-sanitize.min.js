...
(function(p, h, q) {
    ...
    function F(a, e) {
        ...
        ; a; ) {
            ...
            if (f.last() && x[f.last()])
                ...
                if (0 === a.indexOf("\x3c!--"))
                    b = a.indexOf("--", 4),
                    0 <= b && a.lastIndexOf("--\x3e", b) === b && (e.comment && e.comment(a.substring(4, b)),
                    a = a.substring(b + 3),
                    g = !1);
                else if (y.test(a)) {
                    if (b = a.match(y))
                    ...
                    K.test(a) && (b = a.match(A)) && (a = a.substring(b[0].length),
                    b[0].replace(A, d),
                    g = !1);
                g && (b = a.indexOf("<"),
                g = 0 > b ? a : a.substring(0, b),
                a = 0 > b ? "" : a.substring(b),
                e.chars && e.chars(r(g)))
            }
            if (a == l)
    ...
    function r(a) {
        ...
        if (e = e[2])
            ...
            e = "textContent"in n ? n.textContent : n.innerText;
        return a + e + d
    }
    function B(a) {
